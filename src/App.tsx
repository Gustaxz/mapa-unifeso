...
function App() {
	...
	return (
		<div className="w-screen h-screen bg-[#9DF561] bg-opacity-16 flex justify-between">
			<div className="flex gap-2 items-center justify-center w-full py-3 absolute top-0">
